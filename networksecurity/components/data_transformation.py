...
class DataTransformation:
        ...
        for column, expected_dtype in schema.items():
            if column in dataframe.columns:
                try:
                    ...
                    raise NetworkSecurityException(f"Column {column} has incorrect data type. Expected: {expected_dtype}, Found: {dataframe[column].dtype}. Error: {e}", sys)
        return dataframe
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # Define the schema for expected data types
            schema = {
                "column1": np.float64,
                "column2": np.float64,
                # Add other columns and their expected data types
            }
            ...
            logging.info("Data types validated and converted")

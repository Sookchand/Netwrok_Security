...
# mlflow.set_tracking_uri("https://dagshub.com/Sookchand/datascience_project.mlflow")
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            model_trainer_artifact = self.train_model(x_train, y_train, x_test, y_test) # Output: Model Trainer Artifact: <networksecurity.entity.artifact_entity.ModelTrainerArtifact object at 0x0000020D3D3D3A00>
            return model_trainer_artifact
